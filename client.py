...
def leftBoard():
    ...
    for box in range(0,11):
        if(box == 0):
            ...
            boxLabel = Label(gameWindow, font=("Helvetica",20), width=3, height=1, relief='ridge', borderwidth=0, bg="white")
...
def finishingBox():
    ...
    finishingBox = Label(gameWindow, text="Home", font=("Chalkboard SE", 32), width=6, height=2, borderwidth=0, bg="green", fg="white")
    finishingBox.place(x=screen_width/2 - 48, y=screen_height/2 -160)
